...
import { d as defineHandler, h as handleCacheHeaders, t as toResponse, a as defineLazyEventHandler, H as HTTPError, b as H3Core } from "./_libs/h3.mjs";
...
const findRouteRules = /* @__PURE__ */ (() => {
  const $0 = [{ name: "cache", route: "/_build/**", handler: cache, options: { "maxAge": 31536e3 } }], $1 = [{ name: "swr", route: "/api/**", options: 3600 }, { name: "cache", route: "/api/**", handler: cache, options: { "swr": true, "maxAge": 3600 } }, { name: "isr", route: "/api/**", options: true }], $2 = [{ name: "headers", route: "/assets/**", handler: headers, options: { "cache-control": "public, max-age=31536000, immutable" } }];
  return (m, p) => {
    let r = [];
...
const _lazy_68BGGq = defineLazyEventHandler(() => import("./_chunks/renderer-template.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_68BGGq };
  return ((_m, p) => {
